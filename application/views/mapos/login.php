...
<body>
  ...
  ?>
      ...
      <img src="<?php echo base_url() ?>assets/img/dashboard-animate.svg" class="left-login-image" alt="Amura OS - Versão: <?= $this->config->item('app_version'); ?>">
    </div>
      ...
      <div class="d-flex flex-column">
        <div class="right-login">
          <div class="container">
            <div class="card">
              <div class="content">
                <div id="newlog" style="text-align: center; justify-content: center; display: flex;">
                  <img src="<?php echo base_url() ?>assets/img/logo-original.png" alt="Amura OS" style="max-height: 90px; max-width: 100%; object-fit: contain;">
                </div>
                ...
                <div class="links-uteis">
                  <p><?= date('Y'); ?> &copy; Amura OS</p>
                </div>
                <a href="#notification" id="call-modal" role="button" class="btn" data-toggle="modal" style="display: none ">notification</a>
                <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-header">
                    <h4 id="myModalLabel">Amura OS</h4>
                  </div>
