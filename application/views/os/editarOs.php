                                    ...
                                    <div class="span12" style="margin-left: 0; padding: 0 1%;">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span6 os-modern-card" style="margin-left: 0; margin-bottom: 15px;">
                                                ...
                                                <textarea class="modern-textarea editor-field" name="descricaoProduto" id="descricaoProduto" placeholder="Ex: Notebook Dell Inspiron 15, Cor Prata, S/N: 987654..."><?php echo $result->descricaoProduto ?></textarea>
                                                ...
                                                <div style="margin-top: 14px;">
                                                    ...
                                                    <textarea class="modern-textarea editor-field" name="defeito" id="defeito" placeholder="Relato do cliente sobre o problema apresentado..."><?php echo $result->defeito ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="span6 os-modern-card" style="margin-bottom: 15px;">
                                                ...
                                                <textarea class="modern-textarea editor-field" name="laudoTecnico" id="laudoTecnico" placeholder="Constatações técnicas, testes efetuados ou solução proposta..."><?php echo $result->laudoTecnico ?></textarea>
                                                ...
                                                <div style="margin-top: 14px;">
                                                    ...
                                                    <textarea class="modern-textarea editor-field" name="observacoes" id="observacoes" placeholder="Informações complementares, número de lacre ou avisos internos..."><?php echo $result->observacoes ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
