    ...
    <div class="amura-header">
        <div class="amura-header-left">
            ...
            <div>
                ...
                <p class="amura-header-subtitle">Cadastre um novo item, valores de custo, venda e parâmetros de estoque</p>
            </div>
        </div>
                ...
                <div class="amura-form-section" style="border-right: 1px solid #1c2a38;">
                    ...
                    <div style="display: grid; grid-template-columns: 180px 1fr; gap: 10px; margin-bottom: 12px;">
                        <div class="control-group amura-form-group">
                            ...
                            <div class="controls">
                                <input id="codDeBarra" class="amura-form-input" type="text" name="codDeBarra" value="<?php echo set_value('codDeBarra'); ?>" placeholder="EAN ou código interno" />
                            </div>
                        </div>
                        <div class="control-group amura-form-group">
                            <label for="descricao" class="control-label amura-form-label">Descrição / Nome do Produto <span class="required">*</span></label>
                            <div class="controls">
                                <input id="descricao" class="amura-form-input" type="text" name="descricao" value="<?php echo set_value('descricao'); ?>" placeholder="Nome completo do item" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="control-group amura-form-group">
                            ...
                            <div class="controls" style="display: flex; gap: 14px; padding-top: 6px;">
                                <label style="display: flex; align-items: center; gap: 6px; cursor: pointer; color: #cbd5e1; font-size: 0.85rem;">
                                    <input type="checkbox" id="entrada" name="entrada" value="1" checked style="margin: 0; width: 16px; height: 16px;"> Entrada
                                </label>
                                <label style="display: flex; align-items: center; gap: 6px; cursor: pointer; color: #cbd5e1; font-size: 0.85rem;">
                                    <input type="checkbox" id="saida" name="saida" value="1" checked style="margin: 0; width: 16px; height: 16px;"> Saída
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="amura-form-section">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 12px;">
                        <div class="control-group amura-form-group">
                            ...
                            <div class="controls">
                                <input id="estoque" class="amura-form-input" type="text" name="estoque" value="<?php echo set_value('estoque'); ?>" placeholder="Quantidade atual" />
                            </div>
                        </div>
                        <div class="control-group amura-form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $.getJSON('<?php echo base_url() ?>assets/json/unidades.json', function(data) {
            ...
            var curUnit = '<?php echo set_value('unidade'); ?>';
            if (curUnit) {
