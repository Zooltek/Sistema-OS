...
<nav id="sidebar">
    <div id="newlog">
        ...
        <div class="title1">
            <img src="<?php echo base_url() ?>assets/img/<?= $configuration['app_theme'] == 'white' ? 'logo-mapos.png' : 'Logo-Claro2.png' ?>" alt="Amura OS">
        </div>
    </div>
    ...
    <!-- Start Pesquisar-->
    <li class="search-box">
        <form style="display: flex" action="<?= site_url('sistema/pesquisar') ?>">
